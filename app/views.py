...
def index():
    ...
    if current_image != "NONE":
        ...
        return render_template('index.html', title='PieFace', hdmichange_status=hdmi_controller.get_hdmi_status, imgchange_status=hdmi_controller.display_output_status())
